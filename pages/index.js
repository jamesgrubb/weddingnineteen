		...
		<>
			...
			<Section
				...
				<p>
					...
					stay speak to Lucy and mention you are part of the wedding
					party.
				</p>
				<p>
					There is also a more affordable B&B a few miles away Church
					Farmhouse, The Street Herringswell, Kennett, IP28 6ST,
					United Kingdom which you can find on{' '}
				...
				<p>
					The nearest larger towns are Bury St Edmunds or Newmarket
					these are about 30mins drive a way.
				</p>
			</Section>
			<Section
				id='Day'
